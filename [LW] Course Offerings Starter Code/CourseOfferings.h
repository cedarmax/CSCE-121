...
class CourseOfferings {
  ...
  public:
	...
	CourseOfferings(const CourseOfferings& origObject);

    /* TODO: Declare copy assignment operator function here. */
	CourseOfferings& operator=(const CourseOfferings& origObject);
...
std::ostream &operator<<(std::ostream &os, const CourseOfferings &str);
